...
#### --> assuming the rating is changable, but customer & restaurants are not
#### --> confirmed in then next section!

- `Review#rating`
  - returns the rating for a restaurant.
#### assuming this means the average review  
